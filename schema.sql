...
create table if not exists public.certificates (
  ...
  icon_svg     text,                   -- optional: raw inner SVG markup for a full-color custom icon (overrides icon_slug)
  icon_viewbox text default '0 0 48 48', -- viewBox to use when icon_svg is set
...
create table if not exists public.skills (
  ...
  icon_svg     text,                   -- optional: raw inner SVG markup for a full-color custom icon (overrides icon_slug)
  icon_viewbox text default '0 0 32 32', -- viewBox to use when icon_svg is set
